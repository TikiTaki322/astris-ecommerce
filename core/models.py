...
class Order(TimeStampedModel):
    ...
    shipping_street = models.CharField(max_length=128)
    shipping_house_number = models.CharField(max_length=10)
    shipping_apartment = models.CharField(max_length=10, blank=True, null=True)
...
class Payment(TimeStampedModel):
    ...
    transaction = models.CharField(max_length=100, blank=True, null=True)  # Outer payment provider
    paid_at = models.DateTimeField(blank=True, null=True)
